...
const negotiateSuffix = (languageCode) => {
  ...
  const suffixes = {
    ...
    gu: '\n\n💡 સોદાબાજીની પ્રેક્ટિસ કરવા "સોદાબાજી સિમ્યુલેટર" પર જાઓ →',
    kn: '\n\n💡 ಚೌಕಾಸಿ ಅಭ್ಯಾಸ ಮಾಡಲು "ಚೌಕಾಸಿ ಸಿಮ್ಯುಲೇಟರ್" ಗೆ ಹೋಗಿ →',
  };
...
const FALLBACK_POOL = {
  ...
  gu: [
    'હમણાં નેટવર્કમાં સમસ્યા છે. થોડીવાર પછી ફરી પ્રયાસ કરો. ત્યાં સુધી બજાર ભાવ તપાસો.',
    'સર્વર સાથે કનેક્શન થતું નથી. તમારું ઇન્ટરનેટ તપાસો અને ફરી પ્રયાસ કરો.',
    'કનેક્શન ધીમું છે. હવામાન વિભાગ તપાસો — વરસાદ હોય તો આજે જ વેચો.',
    'સર્વર વ્યસ્ત છે. થોડીવાર પછી ફરી પ્રયાસ કરો.',
    'અસ્થાયી સમસ્યા. કૃપા કરી થોડીવાર પછી ફરી પૂછો.',
    'હમણાં જવાબ મળતો નથી. તમારા પાકનો ફોટો Disease સ્ક્રીન પર અપલોડ કરો.',
  ],
  kn: [
    'ಈಗ ನೆಟ್‌ವರ್ಕ್‌ನಲ್ಲಿ ಸಮಸ್ಯೆ ಇದೆ. ಸ್ವಲ್ಪ ಸಮಯದ ನಂತರ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ. ಅಲ್ಲಿಯವರೆಗೆ ಮಾರುಕಟ್ಟೆ ಬೆಲೆ ತಪಾಸಿ.',
    'ಸರ್ವರ್‌ಗೆ ಸಂಪರ್ಕವಾಗುತ್ತಿಲ್ಲ. ನಿಮ್ಮ ಇಂಟರ್ನೆಟ್ ಪರಿಶೀಲಿಸಿ ಮತ್ತು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.',
    'ಸಂಪರ್ಕ ನಿಧಾನವಾಗಿದೆ. ಹವಾಮಾನ ವಿಭಾಗ ಪರಿಶೀಲಿಸಿ — ಮಳೆ ಬಂದರೆ ಇಂದೇ ಮಾರಿ.',
    'ಸರ್ವರ್ ಕಾರ್ಯನಿರತವಾಗಿದೆ. ಸ್ವಲ್ಪ ಸಮಯದ ನಂತರ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.',
    'ತಾತ್ಕಾಲಿಕ ಸಮಸ್ಯೆ. ದಯವಿಟ್ಟು ಸ್ವಲ್ಪ ಸಮಯದ ನಂತರ ಮತ್ತೆ ಕೇಳಿ.',
    'ಈಗ ಉತ್ತರ ಸಿಗುತ್ತಿಲ್ಲ. ನಿಮ್ಮ ಬೆಳೆಯ ಫೋಟೋ Disease ಸ್ಕ್ರೀನ್‌ನಲ್ಲಿ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ.',
  ],
};

let _fallbackIndex = { hi: 0, en: 0, mr: 0, gu: 0, kn: 0 };
